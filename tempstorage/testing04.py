...
PROMPT_PATH = "/mnt/common/lx/Temp01/solver_retry_prompt.txt"
OUTPUT_REPORT_PATH = "/mnt/common/lx/Temp01/testing04_report.json"
DATASET_PATH = "/mnt/common/lx/Temp01/math500_hf"

FAILED_OUTPUT_TOKEN_LIMIT = 10000
MAX_TOKENS = 20000
...
def main() -> None:
    ...
    for i, case in enumerate(wrong_cases, start=1):
        ...
        print(f"[{i}/{len(wrong_cases)}] 重试 unique_id={case.get('unique_id')}")
        try:
